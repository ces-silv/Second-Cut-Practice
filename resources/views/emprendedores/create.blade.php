...
<div class="container mx-auto max-w-3xl px-4 py-6">
    <h1 class="text-3xl font-bold text-white mb-6">Nuevo Emprendedor</h1>
    ...
    <form action="{{ route('emprendedores.store') }}" method="POST" class="bg-gray-900 p-6 rounded-lg shadow-lg border border-gray-700">
        @csrf
